...
public class OrderTreeV25 {
	...
	public OrderTreeV25(String storeRootPath)
	{
	...
	{
		DiskV25 disk = disks.get(posInfo.getDiskId());
	...
	private void mergeSortedOrderIndexFiles(ArrayList<DiskV25> disks) throws Exception
	{
